...
public class PlayerInputHandler : MonoBehaviour
{
    ...
    {
        //TODO List out the reasons why a curser may be in a locked state?
        //TODO How do we manually indicate that game is ending, aka short term goal , kill all bots game is over
    ...
    public bool GetAimInputHeld()
    {
        if (CanProcessInput())
        {
            //Why would our axis be oF - does that mean we're not aiming at anything/
            //or does if mean that we doesn't have a weapon
